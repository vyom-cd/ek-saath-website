...
(function () {
  ...
  const SIDE_PICKS = [
    ...
    { name: 'Hojicha Latte', origin: 'Kyoto, Japan', desc: 'Roasted green tea steamed with milk. Toasty, low-caffeine, mellow.', photo: 'assets/menu/hojicha-latte.jpg?v=2', alt: 'Hojicha latte with foam in a ceramic cup', tags: ['Toasty','Mellow'] },
